...
<div class="operation_user clearfix">
    <div class="link fr">
        ...
        </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="icon icon_i">首页</a><span></span><a href="#" class="icon icon_t">前进</a><span></span><a href="#" class="icon icon_j">后退</a><span></span><a href="#" class="icon icon_n">刷新</a><span></span><a href="doAdminAction.php?act=logout" class="icon icon_e">退出</a>
    </div>
</div>
            ...
            <ul class="mList">
                <li>
                    ...
                    <dl id="menu1" style="display:none;">
                        ...
                        <dd><a href="listPro2.php" target="mainFrame">商品列表</a></dd>
                    </dl>
                </li>
                <li>
                ...
                <li>
                    <h3><span onclick="show('menu6','change6')" id="change6">+</span>图片管理</h3>
